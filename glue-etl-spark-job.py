...
s3_path = f"s3://aws-glue-s3-bucket/Glue_ETL_PJ/source_csv_backup/{timestamp_backup}/"
...
s3_path = f"s3://aws-glue-s3-bucket/Glue_ETL_PJ/transformed_csv/{timestamp_target}/"
...
s3output = glueContext.getSink(
  path="s3://aws-glue-s3-bucket/Glue_ETL_PJ/transformed_paraquet/",
  connection_type="s3",
